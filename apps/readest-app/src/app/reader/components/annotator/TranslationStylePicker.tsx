    ...
    <div className='flex flex-col gap-2'>
      <div className='flex items-center gap-2'>
        ...
        <div className='flex items-center gap-1'>
          ...
          >
            <span className='text-xs' style={{ textDecoration: 'underline', textUnderlineOffset: 2 }}>
              U
            </span>
          </button>
          <button
          ...
          >
            <span className='text-xs' style={{ textDecoration: 'underline wavy', textUnderlineOffset: 2 }}>
              S
            </span>
          </button>
        </div>
